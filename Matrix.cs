        ...
        */
        ...
        public long Determinant()
        {
            ...
            switch (this.rows)
            {
                ...
                case 3:
                    // Using Sarrus
                    return (this.matrix[0, 0] * this.matrix[1, 1] * this.matrix[2,2] + this.matrix[0, 1] * this.matrix[1, 2] * this.matrix[2, 0] + this.matrix[0, 2] * this.matrix[1, 0] * this.matrix[2, 1]) -
                           (this.matrix[0, 1] * this.matrix[1, 0] * this.matrix[2,2] + this.matrix[0, 0] *this.matrix[1, 2] * this.matrix[2, 1] + this.matrix[0, 2] * this.matrix[1, 1] * this.matrix[2, 0]);
            }
